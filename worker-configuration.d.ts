/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8837c7b8359580b64f03cb1bd04334b)
// Runtime types generated with workerd@1.20260617.1 2026-06-10 nodejs_compat
interface __BaseEnv_Env {
	AE: AnalyticsEngineDataset;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	BRAND_NAME: "OGInstagram";
	BRAND_COLOR: "#ff0069";
	SUPPORT_URL: "https://ko-fi.com/afuru";
	GITHUB_URL: "https://github.com/AfuruX/OGInstagram";
	PROXY_USERNAME: string;
	PROXY_PASSWORD: string;
	AE_ACCOUNT_ID: string;
	AE_API_TOKEN: string;
	BASE_URL: string;
	OG_CONTAINER: DurableObjectNamespace<import("./worker/index").OgUsContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "OgUsContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BRAND_NAME" | "BRAND_COLOR" | "SUPPORT_URL" | "GITHUB_URL" | "PROXY_USERNAME" | "PROXY_PASSWORD" | "AE_ACCOUNT_ID" | "AE_API_TOKEN" | "BASE_URL">> {}
}
